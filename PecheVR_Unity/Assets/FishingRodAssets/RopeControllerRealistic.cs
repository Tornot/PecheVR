...
public class RopeControllerRealistic : MonoBehaviour
{
    ...
    //Rope data (length of a section of rope)
    private float ropeSectionLength = 0.2f;
    public float numberOfRopeSection = 5;
    ...
    private Vector3 upDirectionForBobber = Vector3.up;
    ...
    void Start()
    {
        ...
        for (int i = 0; i < numberOfRopeSection; i++)
        {
    ...
    void Update()
    {
        ...
        whatIsHangingFromTheRope.LookAt(allRopeSections[1].pos, upDirectionForBobber);
    }
    ...
    private void DisplayRope()
    {
        ...
        float ropeWidth = this.ropeWidth;
    ...
    public float getRopeSectionLength()
    {
        return ropeSectionLength;
    }
}
